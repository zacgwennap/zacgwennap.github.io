...
A thrust vector controlled rocket is a rocket that can adjust the direction of its propulsive elements to maintain stability and control its trajectory during flight. This technique is famously employed by SpaceX for their rockets.
...
{% include image-single.html src="assets/tvc.jpg" alt="Image of the TVC" %}
...
{% include image-single.html src="assets/piston_mechanism.jpg" alt="Image of the Piston Mechanism" %}
...
{% include image-single.html src="assets/flight_board.jpg" alt="Custom PCB for the flight computer" %}
...
{% include image-single.html src="assets/rocket_sim.jpg" alt="Output plots of the simulation" %}

---

## Skills Applied

- Originally modeled in **Fusion 360**, then redesigned in **SolidWorks**
- PCB schematic designed in **Autodesk Eagle**; flight computer ran **C** and **Arduino**
